...
public class DelayedMqConfig {
    ...
    public static final String exchange_delay = "exchange.pay.check";
    public static final String routing_delay = "routing.pay.check";
    public static final String queue_delay_1 = "queue.pay.check";
